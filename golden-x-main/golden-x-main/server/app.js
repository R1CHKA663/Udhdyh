...
const server = require("https").createServer({
    key: fs.readFileSync('/etc/letsencrypt/live/golden-x.vip/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/golden-x.vip/fullchain.pem')
}),
io = require("socket.io")(server, {
    cors: {
        origin: "https://golden-x.vip",
        methods: ["GET", "POST"]
    }
});
