        ...
        <div class="sidebar">
            ...
            <div class="tc-wrapper">
                ...
                <div class="footer">
                    ...
                    <a class="gx-btn" href="https://vk.com/public{{\App\Setting::first()->group_id}}" target="_blank">
...
<path d="M12.5055 15.5188C8.6214 15.5188 6.40677 12.7804 6.31592 8.21639H8.26933C8.3318 11.5633 9.76279 12.9793 10.8985 13.2719V8.21639H12.7327V11.1011C13.8513 10.9782 15.0325 9.66166 15.43 8.21054H17.2584C17.1094 8.96171 16.8115 9.67313 16.3836 10.3003C15.9556 10.9276 15.4068 11.4571 14.7713 11.8559C15.4805 12.2196 16.1068 12.7341 16.6089 13.3655C17.111 13.9969 17.4776 14.7308 17.6843 15.5188H15.6685C15.2369 14.1321 14.158 13.0554 12.7327 12.9091V15.5188H12.5112H12.5055Z" fill="white"/>
                    ...
                    <a class="gx-btn" href="https://t.me/{{\App\Setting::first()->tg_id}}" target="_blank">
...
<path d="M14.1667 10.4167C16.0784 10.4167 19.5833 11.1309 19.5833 13.9881C19.5833 15.2381 19.2647 15.4167 18.6275 15.4167L13.5523 15.4173C13.684 15.0097 13.75 14.5317 13.75 13.9881C13.75 12.5524 13.2239 11.4324 12.3568 10.6032C13.0094 10.4695 13.6469 10.4167 14.1667 10.4167ZM6.66667 10.4167C8.57843 10.4167 12.0833 11.1309 12.0833 13.9881C12.0833 15.2381 11.7647 15.4167 11.1275 15.4167H2.20588C1.56863 15.4167 1.25 15.2381 1.25 13.9881C1.25 11.1309 4.7549 10.4167 6.66667 10.4167ZM6.66667 4.16666C8.04792 4.16666 9.16667 5.28541 9.16667 6.66666C9.16667 8.04791 8.04792 9.16666 6.66667 9.16666C5.28542 9.16666 4.16667 8.04791 4.16667 6.66666C4.16667 5.28541 5.28542 4.16666 6.66667 4.16666ZM14.1667 4.16666C15.5479 4.16666 16.6667 5.28541 16.6667 6.66666C16.6667 8.04791 15.5479 9.16666 14.1667 9.16666C12.7854 9.16666 11.6667 8.04791 11.6667 6.66666C11.6667 5.28541 12.7854 4.16666 14.1667 4.16666Z" fill="#7785B3"/>
                        ...
                        <li>
                            <a onclick="load('support')"  class="d-flex align-center">
                                <svg class="icon"><use xlink:href="images/symbols.svg?v=29#support"></use></svg>
                                <span>Поддержка</span>
                            </a>
                        </li>
                        @if ($u && in_array($u->admin, [1]))
                        <li>
                            <a href="/admin" target="_blank" class="d-flex align-center">
                                <svg class="icon"><use xlink:href="images/symbols.svg#users"></use></svg>
                                <span>Админка</span>
                            </a>
                        </li>
                        @endif
                        @if ($u && in_array($u->admin, [2]))
                        <li>
                            <a href="/admin" target="_blank" class="d-flex align-center">
                                <svg class="icon"><use xlink:href="images/symbols.svg#users"></use></svg>
                                <span>Модератор</span>
                        ...
                        <div class="header__user d-flex align-center justify-space-between">
                            <div class="header__user-balance d-flex align-center">
                                ...
                                <div class="header__user-balance-add">
                                    <a href="#" onclick="$('.wallet__method--sort-{{$min_sort}}_DEPOSIT').click();$('.wallet__method--Qiwi_WITHDRAW').click()" rel="popup" data-popup="popup--wallet" onclick="return false;" style="gap: 5px;" class="btn is-ripples flare d-flex align-center"><svg xmlns="http://www.w3.org/2000/svg"  width="18" height="18" viewBox="0 0 21 18" fill="none">
                            ...
                            <div style="margin-left: 15px;">
                                <a href="#" onclick="__toggleChat(1)();" style="gap: 5px;padding:0;" class="btn d-flex align-center chat-aside">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                        <rect width="48" height="48" rx="12" fill="#3B7BE6"/>
                                        <path d="M21.4735 15.1579C25.6592 15.1579 29.0524 18.0644 29.0524 21.6498C29.0524 25.2352 25.6592 27.7895 21.4735 27.7895C20.6153 27.7895 19.7904 27.6673 19.0213 27.4421C18.1618 28.1051 16.9638 29.014 15.1577 29.4634C15.0722 29.4846 14.9817 29.4728 14.9047 29.4302C14.7377 29.3377 14.6779 29.1285 14.7711 28.9629L14.9003 28.7303C15.5002 27.6356 15.7394 26.7379 15.888 26.037C14.6498 24.8818 13.8945 23.3414 13.8945 21.6498C13.8945 18.0644 17.2877 15.1579 21.4735 15.1579Z" fill="white"/>
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M21.4746 29.4737C22.8148 30.5339 24.6492 31.1553 26.6724 31.1553C27.5141 31.1553 28.323 31.033 29.0773 30.8075L29.085 30.8136C29.9272 31.477 31.0774 32.3831 32.8433 32.8318C32.9271 32.8531 33.0159 32.8412 33.0914 32.7985C33.2551 32.7059 33.3138 32.4964 33.2224 32.3306L33.0957 32.0975C32.5074 31.0012 32.2958 30.1021 32.15 29.4002C33.3644 28.2433 34.1051 26.7005 34.1051 25.0064C34.1051 22.5967 32.6065 20.4932 30.3802 19.37C30.6115 20.0856 30.7366 20.8489 30.7366 21.6498C30.7366 26.5094 26.2036 29.4732 21.4746 29.4737Z" fill="white"/>
                                    </svg>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="gx-row flex-wrap justify-space-between align-center gx-gap gx-mh-0">
                            <div class="gx-col">
                                <div class="gx-row align-center">
                                    ...
                                    <span class="text-gray">GOLDEN-X.VIP – Экономическая онлайн стратегия</span>
                                </div>
                            </div>
                            <div class="gx-col justify-center">
                                <div class="gx-row align-center gx-gap">
                                    ...
                                    <div class="gx-row gx-gap">
                                        <a class="gx-btn soc" href="https://vk.com/public{{\App\Setting::first()->group_id}}" target="_blank">
...
<path d="M7.07573 11.5221C10.0426 10.2295 12.021 9.37733 13.0109 8.96559C15.8373 7.79001 16.4246 7.5858 16.8074 7.57898C16.8916 7.57757 17.0798 7.59844 17.2018 7.69738C17.3047 7.78093 17.3331 7.89379 17.3466 7.973C17.3602 8.05221 17.3771 8.23265 17.3636 8.37365C17.2105 9.98293 16.5477 13.8882 16.2106 15.6907C16.0679 16.4533 15.787 16.7091 15.5151 16.7341C14.924 16.7885 14.4752 16.3435 13.9028 15.9683C13.0071 15.3811 12.501 15.0156 11.6316 14.4426C10.6267 13.7804 11.2781 13.4165 11.8508 12.8217C12.0006 12.6661 14.6047 10.2975 14.6551 10.0826C14.6614 10.0558 14.6672 9.95558 14.6077 9.90269C14.5482 9.8498 14.4604 9.86789 14.397 9.88227C14.3072 9.90266 12.8762 10.8485 10.1041 12.7197C9.69796 12.9986 9.33006 13.1345 9.00044 13.1274C8.63705 13.1195 7.93804 12.9219 7.4184 12.753C6.78105 12.5458 6.27449 12.4363 6.3186 12.0844C6.34157 11.9012 6.59395 11.7137 7.07573 11.5221Z" fill="white"></path>
            ...
            <div class="mobile-menu d-flex align-center">
                ...
                <span class="mobile_p">Чат</span>
                    ...
                    <li><a class="btn_active btn_" onclick="load('')"><svg class="icon_mobiles"><use xlink:href="images/symbols.svg#game_menu"></use></svg>
...
<path d="M22.5 12V16.5H18.75C17.5073 16.5 16.5 15.4927 16.5 14.25C16.5 13.0073 17.5073 12 18.75 12H22.5Z" />
</svg>
                    </a>
                    <span class="mobile_p">Кошелек</span>
                </li>
                    <li><a href="#" id="moreBtn">
                    <svg class="icon_mobiles" width="512" height="512" fill="currentColor" viewBox="0 0 512 512" class=""><g><path d="M31.125 126.493h449.757c17.162 0 31.118-13.956 31.118-31.118S498.044 64.25 480.882 64.25H31.125C13.963 64.25 0 78.213 0 95.375s13.963 31.118 31.125 31.118zM480.882 224.875H31.125C13.963 224.875 0 238.838 0 256s13.963 31.118 31.125 31.118h449.757C498.044 287.118 512 273.162 512 256s-13.956-31.125-31.118-31.125zM480.882 385.5H31.125C13.963 385.5 0 399.471 0 416.632c0 17.162 13.963 31.118 31.125 31.118h449.757c17.162 0 31.118-13.956 31.118-31.118 0-17.161-13.956-31.132-31.118-31.132z"></path></g></svg>
                    </svg>
                </a>
            ...
            <div class="mobile-navbar d-flex flex-column">
                <li class="d-flex flex-column">
                    ...
                    @if ($u && in_array($u->admin, [1]))
                    <a href="/admin" target="_blank"><svg class="icon mobilesli"><use xlink:href="images/symbols.svg#users"></use></svg> Админка</a>
                    @endif
                    @if ($u && in_array($u->admin, [2]))
                    <a href="/admin" target="_blank"><svg class="icon mobilesli"><use xlink:href="images/symbols.svg#users"></use></svg> Модератор</a>
                    @endif
        ...
        <script src="/js/script.js?v=30" type="text/javascript"></script>
    </div>
  ...
  <g style="mix-blend-mode:luminosity" filter="url(#filter0_f_223_20549)">
    <path d="M22.1197 29.1767L23.5347 34.4271C24.2377 36.9015 26.393 38.8615 29.9416 39.8123C37.8726 41.9374 49.7366 38.2254 56.4407 31.5213C60.2353 27.7267 61.5613 23.7875 60.5612 20.6971L59.2141 15.6478L22.1197 29.1767Z" fill="url(#paint0_linear_223_20549)"/>
    <path d="M38.9541 32.1432L31.9694 32.76L34.0152 40.3951C36.2305 40.4766 38.5969 40.2294 40.9777 39.6955L38.9541 32.1432Z" fill="url(#paint1_linear_223_20549)"/>
    <path d="M58.1069 29.6477C60.6059 26.4579 61.397 23.2808 60.5608 20.6972L59.2137 15.6478L56.4351 23.4084L58.1069 29.6477Z" fill="url(#paint2_linear_223_20549)"/>
    <path d="M26.3011 18.546C19.5971 25.25 20.5917 32.4075 28.5227 34.5326C36.4537 36.6576 48.3176 32.9457 55.0217 26.2417C61.7257 19.5376 60.7311 12.3801 52.8001 10.2551C44.8691 8.13002 33.0052 11.8419 26.3011 18.546Z" fill="url(#paint3_linear_223_20549)"/>
    <path d="M28.5226 34.5328C36.4536 36.6579 48.3176 32.9459 55.0217 26.2419C56.6938 24.5697 57.8869 22.8693 58.6129 21.2259L23.3437 22.3175C20.2114 27.7502 22.0741 32.8048 28.5226 34.5328Z" fill="url(#paint4_linear_223_20549)"/>
    ...
    <path d="M23.9319 27.6284C23.9839 28.0025 24.07 28.3607 24.1862 28.7038C24.1595 28.5747 24.1355 28.4442 24.117 28.3112C23.3424 22.7371 30.2046 15.8748 39.4442 12.984C48.0638 10.2872 55.7061 11.9998 57.3222 16.7672C56.2275 11.4853 48.2782 9.47931 39.2591 12.3012C30.0196 15.192 23.1574 22.0542 23.9319 27.6284Z" fill="url(#paint8_linear_223_20549)"/>
  </g>
  <g style="mix-blend-mode:luminosity">
    <path d="M38.5553 148.14L36.1542 139.23C34.9613 135.032 31.3039 131.706 25.2823 130.092C11.8241 126.486 -8.30794 132.785 -19.6841 144.161C-26.1231 150.6 -28.3733 157.285 -26.6761 162.529L-24.3902 171.097L38.5553 148.14Z" fill="url(#paint9_linear_223_20549)"/>
    <path d="M9.98795 143.106L21.8402 142.059L18.3687 129.103C14.6096 128.965 10.594 129.385 6.55413 130.291L9.98795 143.106Z" fill="url(#paint10_linear_223_20549)"/>
    <path d="M31.4581 166.179C42.8343 154.803 41.1465 142.657 27.6883 139.051C14.2301 135.445 -5.90176 141.744 -17.2779 153.12C-28.654 164.496 -26.9662 176.642 -13.5081 180.248C-0.0498806 183.854 20.082 177.555 31.4581 166.179Z" fill="url(#paint11_linear_223_20549)"/>
    <path d="M27.6896 139.051C14.2315 135.445 -5.90067 141.744 -17.2768 153.12C-20.1142 155.957 -22.1387 158.843 -23.3707 161.632L36.4776 159.779C41.7929 150.56 38.632 141.983 27.6896 139.051Z" fill="url(#paint12_linear_223_20549)"/>
    <path d="M8.44997 169.432C9.1634 169.209 9.86224 168.961 10.5438 168.692C12.1982 168.037 12.8156 167.023 12.1277 166.137L11.2263 164.976C10.7494 164.362 9.05162 164.162 7.79864 164.556C7.79017 164.559 7.78189 164.561 7.77342 164.564C3.27416 165.972 -0.678879 164.913 -1.05611 162.198C-1.43333 159.484 1.90827 156.142 6.40754 154.735C10.9068 153.327 14.8598 154.386 15.2371 157.1C15.2375 157.104 15.2381 157.108 15.2386 157.112C15.3153 157.68 16.5827 158.04 17.8195 157.83L20.5682 157.364C22.2024 157.087 23.3301 156.397 23.3581 155.642C23.3714 155.282 23.3549 154.926 23.3061 154.576C22.5553 149.173 14.6866 147.064 5.7308 149.866C-3.22491 152.668 -9.87633 159.32 -9.12554 164.723C-8.37456 170.126 -0.505744 172.234 8.44997 169.432Z" fill="url(#paint13_linear_223_20549)"/>
    ...
    <path d="M-16.9111 167.653C-16.9413 167.498 -16.969 167.343 -16.991 167.184C-18.1059 159.16 -8.22797 149.282 5.07203 145.121C17.431 141.254 28.3942 143.685 30.7787 150.487C29.2797 142.812 17.795 139.883 4.75785 143.962C-8.54216 148.123 -18.4201 158.001 -17.3052 166.025C-17.2263 166.593 -17.0927 167.135 -16.9111 167.653Z" fill="url(#paint15_linear_223_20549)"/>
    <path d="M35.4794 150.767C35.3912 150.132 35.245 149.524 35.0478 148.942C35.0932 149.161 35.1339 149.383 35.1653 149.608C36.4797 159.067 24.8352 170.712 9.15652 175.617C-5.47004 180.193 -18.4384 177.287 -21.1807 169.197C-19.3231 178.16 -5.83391 181.564 9.4706 176.776C25.1492 171.87 36.7937 160.226 35.4794 150.767Z" fill="url(#paint16_linear_223_20549)"/>
  </g>
  <defs>
    <filter id="filter0_f_223_20549" x="17.8576" y="5.65641" width="47.0247" height="38.7546" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      ...
      <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_223_20549"/>
    </filter>
    <linearGradient id="paint0_linear_223_20549" x1="51.3106" y1="27.3607" x2="20.8994" y2="35.5093" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="0.2216" stop-color="#FFC538"/>
      <stop offset="0.3753" stop-color="#FFA538"/>
      <stop offset="0.5003" stop-color="#FBC23C"/>
      <stop offset="0.6256" stop-color="#F8D840"/>
      <stop offset="0.7058" stop-color="#F7E041"/>
      <stop offset="0.7857" stop-color="#F9D53F"/>
      <stop offset="0.9265" stop-color="#FDB73B"/>
    ...
    <linearGradient id="paint5_linear_223_20549" x1="-0.69883" y1="64.5542" x2="64.3354" y2="-0.480112" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="0.5493" stop-color="#FFA538"/>
      <stop offset="0.9892" stop-color="#FFC538"/>
    </linearGradient>
  ...
  <g style="mix-blend-mode:luminosity">
    <path d="M14.0301 7.85745L8.88803 13.0144C6.48885 15.4867 5.6589 19.2991 6.93227 24.0516C9.77842 34.6733 22.0283 45.948 34.2932 49.2344C41.2353 51.0945 46.6922 49.9946 49.6068 46.7652L54.5611 41.8216L14.0301 7.85745Z" fill="url(#paint0_linear_223_20572)"/>
    <path d="M21.8625 29.3695L16.47 21.6815L8.98443 29.167C10.3733 31.7908 12.2447 34.37 14.4581 36.7738L21.8625 29.3695Z" fill="url(#paint1_linear_223_20572)"/>
    <path d="M37.5825 49.9128C42.9555 50.6753 47.1702 49.4653 49.6069 46.7654L54.5612 41.8218L43.6996 43.7958L37.5825 49.9128Z" fill="url(#paint2_linear_223_20572)"/>
    <path d="M29.1601 5.58902C16.8952 2.30264 9.25969 8.24915 12.1058 18.8709C14.952 29.4926 27.2017 40.7673 39.4666 44.0536C51.7315 47.34 59.367 41.3935 56.5209 30.7717C53.6747 20.15 41.425 8.87539 29.1601 5.58902Z" fill="url(#paint3_linear_223_20572)"/>
    <path d="M12.1058 18.8708C14.9518 29.4925 27.2017 40.7673 39.4666 44.0536C42.5257 44.8733 45.2969 45.1184 47.6891 44.86L22.8056 4.68432C14.407 4.68929 9.79177 10.2345 12.1058 18.8708Z" fill="url(#paint4_linear_223_20572)"/>
    <path d="M40.4635 20.0316C40.0294 19.632 39.5843 19.2521 39.1311 18.8927C38.031 18.0201 37.0942 17.9982 36.7601 18.8181L36.3221 19.8924C36.0905 20.4608 36.6237 21.7002 37.3877 22.401C37.3929 22.4057 37.3979 22.4103 37.4031 22.4151C40.1407 24.9348 40.9767 28.0548 39.2703 29.3837C37.5638 30.7127 33.9612 29.7474 31.2235 27.2276C28.4859 24.7079 27.6499 21.5879 29.3563 20.2589C29.3588 20.2571 29.3611 20.2552 29.3636 20.2534C29.7218 19.9767 29.4672 18.9686 28.8357 18.206L27.4324 16.5112C26.5981 15.5036 25.6821 15.0047 25.1549 15.2837C24.9036 15.4165 24.6668 15.5684 24.4464 15.74C21.0498 18.3853 22.7139 24.5956 28.1632 29.6112C33.6125 34.6268 40.7836 36.5482 44.1802 33.903C47.5769 31.2575 45.9128 25.0471 40.4635 20.0316Z" fill="url(#paint5_linear_223_20572)"/>
    <path d="M45.0809 16.436C35.5408 7.6554 22.9866 4.29151 17.0402 8.92255C11.0938 13.5536 14.007 24.4259 23.547 33.2065C33.0871 41.9871 45.6414 45.351 51.5878 40.72C57.5341 36.089 54.6209 25.2166 45.0809 16.436ZM48.9672 38.3081C43.9228 42.2365 33.2732 39.383 25.1804 31.9345C17.0878 24.4859 14.6165 15.263 19.6608 11.3346C24.7051 7.40619 35.3548 10.2598 43.4475 17.7083C51.5401 25.1567 54.0114 34.3795 48.9672 38.3081Z" fill="url(#paint6_linear_223_20572)"/>
    <path d="M49.2556 38.0684C49.1618 38.1502 49.0662 38.2306 48.9664 38.3082C43.9221 42.2366 33.2724 39.3831 25.1797 31.9346C17.6596 25.0131 14.9949 16.5604 18.7028 12.2466C14.0487 16.2997 16.5789 25.3053 24.5117 32.6066C32.6044 40.0551 43.2541 42.9087 48.2984 38.9802C48.6553 38.7023 48.9733 38.3969 49.2556 38.0684Z" fill="url(#paint7_linear_223_20572)"/>
    <path d="M17.0393 8.92267C16.6401 9.23346 16.2824 9.57328 15.9623 9.93778C16.0942 9.82034 16.2294 9.70512 16.3712 9.59459C22.3176 4.96355 34.872 8.32748 44.412 17.1081C53.3118 25.2995 56.4431 35.3103 51.9959 40.377C57.3889 35.5704 54.3924 25.0073 45.08 16.4362C35.54 7.65555 22.9858 4.29166 17.0393 8.92267Z" fill="url(#paint8_linear_223_20572)"/>
  </g>
  <g style="mix-blend-mode:luminosity" filter="url(#filter0_f_223_20572)">
    <path d="M93.0424 159.63L91.5765 154.191C90.8482 151.627 88.6152 149.597 84.9388 148.611C76.7221 146.41 64.4308 150.255 57.4853 157.201C53.554 161.132 52.1802 165.213 53.2164 168.415L54.612 173.646L93.0424 159.63Z" fill="url(#paint9_linear_223_20572)"/>
    <path d="M75.6014 156.557L82.8376 155.918L80.7181 148.008C78.4231 147.923 75.9714 148.179 73.5049 148.733L75.6014 156.557Z" fill="url(#paint10_linear_223_20572)"/>
    <path d="M55.759 159.142C53.17 162.447 52.3505 165.738 53.2168 168.415L54.6123 173.646L57.491 165.606L55.759 159.142Z" fill="url(#paint11_linear_223_20572)"/>
    <path d="M88.7103 170.644C95.6558 163.698 94.6254 156.283 86.4087 154.081C78.192 151.88 65.9008 155.725 58.9553 162.671C52.0098 169.616 53.0402 177.032 61.2569 179.233C69.4736 181.435 81.7648 177.589 88.7103 170.644Z" fill="url(#paint12_linear_223_20572)"/>
    <path d="M86.4088 154.081C78.1922 151.879 65.9008 155.725 58.9553 162.671C57.2229 164.403 55.9869 166.165 55.2347 167.867L91.7742 166.736C95.0193 161.108 93.0895 155.871 86.4088 154.081Z" fill="url(#paint13_linear_223_20572)"/>
    <path d="M74.6626 172.63C75.0982 172.494 75.5249 172.342 75.941 172.178C76.951 171.778 77.328 171.159 76.908 170.618L76.3576 169.909C76.0665 169.534 75.03 169.412 74.265 169.653C74.2598 169.655 74.2547 169.656 74.2496 169.658C71.5026 170.517 69.0892 169.871 68.8588 168.213C68.6285 166.556 70.6687 164.516 73.4157 163.657C76.1626 162.797 78.5761 163.444 78.8064 165.101C78.8067 165.103 78.807 165.106 78.8073 165.108C78.8541 165.455 79.628 165.674 80.3831 165.546L82.0612 165.262C83.059 165.092 83.7475 164.672 83.7645 164.211C83.7727 163.991 83.7626 163.774 83.7328 163.56C83.2744 160.261 78.4703 158.974 73.0025 160.684C67.5347 162.395 63.4738 166.456 63.9322 169.755C64.3907 173.053 69.1949 174.341 74.6626 172.63Z" fill="url(#paint14_linear_223_20572)"/>
    <path d="M75.2858 177.114C84.8582 174.119 91.9675 167.009 91.165 161.234C90.3625 155.459 81.9521 153.206 72.3797 156.201C62.8074 159.196 55.698 166.305 56.5005 172.08C57.303 177.855 65.7135 180.108 75.2858 177.114ZM59.1299 171.257C58.4492 166.358 64.48 160.328 72.6001 157.787C80.7203 155.247 87.8548 157.158 88.5355 162.057C89.2162 166.956 83.1854 172.987 75.0653 175.527C66.9452 178.068 59.8107 176.156 59.1299 171.257Z" fill="url(#paint15_linear_223_20572)"/>
    <path d="M59.1788 171.543C59.1603 171.449 59.1435 171.354 59.13 171.257C58.4493 166.358 64.4801 160.327 72.6002 157.787C80.1458 155.426 86.8392 156.91 88.295 161.063C87.3798 156.377 80.3681 154.589 72.4084 157.079C64.2883 159.62 58.2575 165.651 58.9382 170.549C58.9863 170.896 59.0679 171.227 59.1788 171.543Z" fill="url(#paint16_linear_223_20572)"/>
  ...
  <defs>
    <filter id="filter0_f_223_20572" x="48.8837" y="143.991" width="48.4301" height="39.8623" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
      <feFlood flood-opacity="0" result="BackgroundImageFix"/>
      <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape"/>
      <feGaussianBlur stdDeviation="2" result="effect1_foregroundBlur_223_20572"/>
    </filter>
...
<path d="M8.728 13.5C3.26109 13.5 0.146781 9.74653 0 3.5H2.73741C2.82469 8.0845 4.84403 10.0248 6.44284 10.4264V3.5H9.02156V7.45228C10.6085 7.28528 12.2589 5.46422 12.8182 3.5H15.393C15.1841 4.52655 14.7662 5.49915 14.1654 6.35734C13.5651 7.21486 12.7945 7.93951 11.9018 8.48609C12.9006 8.98358 13.7823 9.68767 14.4884 10.5517C15.1951 11.4165 15.7103 12.4214 16 13.5H13.1634C12.5564 11.5994 11.0369 10.1282 9.0295 9.92147V13.5H8.728Z" fill="white"/>
</svg>
ВКонтакте</span>
</a>
...
<path d="M8 7.04547V10.1437H12.3055C12.1164 11.14 11.5491 11.9837 10.6982 12.551L13.2945 14.5656C14.8073 13.1692 15.68 11.1183 15.68 8.68192C15.68 8.11466 15.6291 7.56915 15.5345 7.04556L8 7.04547Z" fill="#4285F4"/>
<path d="M3.51675 10.0227L2.93117 10.471L0.858398 12.0855C2.17477 14.6964 4.87276 16.5001 8.00003 16.5001C10.16 16.5001 11.9709 15.7874 13.2946 14.5656L10.6982 12.551C9.98546 13.031 9.07635 13.3219 8.00003 13.3219C5.92003 13.3219 4.1528 11.9183 3.52002 10.0274L3.51675 10.0227Z" fill="#34A853"/>
<path d="M0.858124 4.91457C0.312696 5.9909 0 7.20547 0 8.5C0 9.79453 0.312696 11.0091 0.858124 12.0854C0.858124 12.0927 3.52 10.02 3.52 10.02C3.36 9.53996 3.26543 9.0309 3.26543 8.49992C3.26543 7.96893 3.36 7.45987 3.52 6.97987L0.858124 4.91457Z" fill="#FBBC05"/>
<path d="M8.00019 3.68547C9.1784 3.68547 10.2257 4.09273 11.062 4.8782L13.3529 2.58731C11.9638 1.29278 10.1602 0.5 8.00019 0.5C4.87293 0.5 2.17477 2.29637 0.858398 4.91458L3.5202 6.98004C4.15289 5.0891 5.92019 3.68547 8.00019 3.68547Z" fill="#EA4335"/>
</g>
<defs>
<clipPath id="clip0_222_11207">
<rect width="15.68" height="16" fill="white" transform="translate(0 0.5)"/>
</clipPath>
</defs>
</svg>
                            Google</span></a>
        ...
        @auth
        <div class="popup popup--changeName" style="max-width:350px">
            <div class="popup__title d-flex align-center justify-space-between">
            ...
            <div class="popup__content">
                <div class="bx-input__input d-flex justify-space-between align-center">
                    <input class="fullInputWidth" style="text-align: left;" placeholder="Введите никнейм" type="text" id="newName">
                    <a onclick="changeName()" class="btn btn--blue d-flex align-center justify-center is-ripples flare has-ripple"><span>Сменить</span><span class="ripple ripple-animate" style="height: 340px; width: 340px; animation-duration: 0.3s; animation-timing-function: linear; background: rgb(255, 255, 255); opacity: 0.4; top: -149px; left: -117.5px;"></span></a>
                </div>
            </div>
        </div>
                    ...
                    <div class="wallet__content-bottom" style="margin-top:10px;">
                        <div class="wallet__order d-flex justify-space-between align-center">
                            <div class="wallet__txt d-flex flex-column">
                                ...
                                <b class="d-flex align-center">К оплате: <span class="d-flex align-center"><b class="">0</b> <svg class="icon money"><use xlink:href="images/symbols.svg#coins"></use></svg></span></b>
                            </div>
        ...
        <div class="popup popup--wallet">
            ...
            <script type="text/javascript">
                function setSystemDep(id){
                    $('#systemDep').val(id)
                    $("#comm").val($("#dep_"+ id).attr('data-com'))
                    $("#comm").html($("#dep_"+ id).attr('data-com'))
                    var sum = Number($('#sumDep').val());
                    $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())
                }
            </script>
            <div class="popup__content">
                <div class="wallet wallet--refill d-flex align-stretch justify-space-between flex-wrap">
                    <div class="wallet__methods">
                        <div class="wallet__scroll" ss-container>
                            ...
                            <div onclick="setSystemDep({{$s->id}})" id="dep_{{$s->id}}" data-com="{{ $s->comm_percent }}" class="wallet__method wallet__method--sort-{{$s->sort}}_DEPOSIT wallet__method--{{$s->id}}_DEPOSIT d-flex align-center">
                                <img src="{{$s->img}}">
                    ...
                    <div class="wallet__content d-flex flex-column justify-space-between">
                        <div class="wallet__content-top">
                            <div class="bx-input d-flex flex-column">
                                <div class="bx-input__input d-flex align-center justify-space-between">
                                        <input type="text" style="text-align: left;" id="sumDep" onkeyup="var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())" placeholder="ВВЕДИТЕ СУММУ">
                                        <svg class="icon money"><use xlink:href="images/symbols.svg#coins"></use></svg>
                                </div>
                            </div>

                        <div class="x30__bet-placed d-flex align-center justify-space-between payments">
                            <a onclick="$('#sumDep').val((Number($('#sumDep').val()) + 10).toFixed(2));var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())">+10</a>
                            <a onclick="$('#sumDep').val((Number($('#sumDep').val()) + 100).toFixed(2));var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())">+100</a>
                            <a onclick="$('#sumDep').val((Number($('#sumDep').val()) + 1000).toFixed(2));var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())">+1000</a>
                            <a onclick="$('#sumDep').val((Number($('#sumDep').val()) * 2).toFixed(2));var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())">x2</a>
                            <a onclick="$('#sumDep').val(Math.max((Number($('#sumDep').val()) / 2), 1).toFixed(2));var sum = Number($('#sumDep').val());  $('.payDep').html(sum += $('#sumDep').val() / 100 * $('#comm').val())">1/2</a>
                        </div>
                            ...
                            <div class="d-flex align-center justify-space-between">
                                <div class="wallet__txt"><span class="d-flex align-center">Комиссия: <b id="comm" value="10">10</b>%</span></div>
                            </div>
                        </div>
                        <div class="wallet__content-bottom">
                            <div class="wallet__order d-flex justify-space-between align-center">
                                <div class="wallet__txt d-flex flex-column">
                                    ...
                                    <b class="d-flex align-center">К оплате: <span class="d-flex align-center"><b class="payDep">0</b> <svg class="icon money"><use xlink:href="images/symbols.svg#coins"></use></svg></span></b>
                                </div>
...
<script type="text/javascript">
    ...
    var ADMIN_CHAT = '';
    @else
    var USER_ADMIN = {{\Auth::user()->admin}};
...
<script>
    ...
    function chatAdd(data){
        ...
        $('.chat__messages .ss-wrapper .ss-content').append('<div id="msg_'+data.id+'" class="chat__msg d-flex align-start">\
            ...
            <b>'+data.time+'</b>\
            <span>'+data.status_mess+' '+data.autor+(USER_ADMIN ? ' #'+ data.user_id : '')+'</span>\
