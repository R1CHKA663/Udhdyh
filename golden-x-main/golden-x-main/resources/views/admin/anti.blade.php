        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('dice')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('mines')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('coin')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('shoot')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('wheel')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <label></label>
                        <button onclick="resetBank('crash')" class="btn btn-primary w-100">Сбросить</button>
                    </div>
                </div>
