<div class="wrapper">
   <div style="margin-top: 35px;" class="keno">
        ...
        <div class="keno__content">
            <div class="keno__round-info d-flex justify-space-between align-center">
                <div class="keno__round-info-item d-flex">
                    <div class="d-flex flex-column ">
                        <span>Банк игры</span>
                        <b><b class="bankKeno"></b> <svg class="icon yellow" style="width: 16px; height: 16px; margin-left: 5px;"><use xlink:href="images/symbols.svg#coins"></use></svg></b>
                    </div>
                    

                    <div class="d-flex flex-column " style="margin-left: 20px;">
                        <span>Игроков</span>
                        <b><b class="usersKeno"></b> <svg class="icon blue" style="width: 16px; height: 16px; margin-left: 5px;"><use xlink:href="images/symbols.svg#users"></use></svg></b>
                    </div>
                </div>
            ...
            <div class="keno__mines d-flex justify-center align-center"> 
            ...
            <div class="keno__bet">
                <div class="keno__bet-settings d-flex align-center justify-space-between flex-wrap">
                    <div class="keno__bet-left d-flex align-center">
                        ...
                        <a href="#" class="shoot__bet-btn-settings d-flex align-center" onclick="disable(this);clearKeno(this)">
                            <svg style="height: 14px; width: 14px;" class="icon"><use xlink:href="images/symbols.svg#close"></use></svg>
                            <span>Отменить выбор</span>
                        </a>
                        <a href="#" class="shoot__bet-btn-settings d-flex align-center lft" onclick="disable(this);autoKeno(this)">
                            <svg style="height: 16px; width: 16px;" class="icon"><use xlink:href="images/symbols.svg#auto"></use></svg>
                            <span>Авто-выбор</span>
                        </a>
                    </div>
                    <div class="keno__bet-right d-flex align-center">
                        <input class="keno__bet-input" type="text" id="sumBetKeno" placeholder="0.00"><svg class="icon money pd20"><use xlink:href="images/symbols.svg#coins"></use></svg>
