			...
			<div class="content-area">
				...
				<div class="flex no_padding wrap">
					<div class="col-lg-5">
						...
						<div style="margin-top: 10px;">
							<span class="text-secondary">Пополнения</span>
						...
						<div style="margin-top: 10px;">
							<span class="text-secondary">Успешные выводы</span>
					...
					<div class="col-lg-5">
						<div class="flex no_padding wrap">
							...
							<div class="col-5 col-lg-4 mb-20">
								...
								<div class="flex no_padding wrap">
					                <div style="position:relative;margin-top: 10px;" class="col">
					                    <input type="" class="secodary_input"  id="user_demo_balance" name="">
					                </div>
					            </div>
							</div>
							<div class="col-5 col-lg-4 mb-20">
