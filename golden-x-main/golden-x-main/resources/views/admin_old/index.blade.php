			...
			<div class="flex no_padding wrap">
				<div class="col">
					<div class="flex no_padding wrap">
						...
						<div class="col-lg-4">
							<div class="content-area " >
								<span class="text-secondary text-admin-title">Crash</span>
								<div class="hr"></div>
								<div class="flex no_padding">
									<div class="col">
										<span class="text-secondary text-admin-title">Банк</span>
										<span class="text-secondary text-admin-title" id="crash_bank" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->crash_bank}}</span>
									</div>
									<div class="col">
										<span class="text-secondary text-admin-title">Заработок</span>
										<span class="text-secondary text-admin-title" id="crash_profit" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->crash_profit}}</span>
									</div>
								</div>
								<button class="btn-dep w-100" onclick="resetBank('crash')">Обнулить письку</button>
						...
						<div class="col-lg-4">
							<div class="content-area " >
								<span class="text-secondary text-admin-title">Coin</span>
								<div class="hr"></div>
								<div class="flex no_padding">
									<div class="col">
										<span class="text-secondary text-admin-title">Банк</span>
										<span class="text-secondary text-admin-title" id="coin_bank" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->coin_bank}}</span>
									</div>
									<div class="col">
										<span class="text-secondary text-admin-title">Заработок</span>
										<span class="text-secondary text-admin-title" id="coin_profit" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->coin_profit}}</span>
									</div>
								</div>
								<button class="btn-dep w-100" onclick="resetBank('coin')">Обнулить письку</button>
								

								<div class="flex no_padding" style="margin-top:10px">
									<input type="" id="idCoinBonus" style="border-radius: 10px 0px 0px 10px;"  placeholder="ID человека" class="secodary_input w-100"  name="">
									<button onclick="giveBonusCoin()" style="border-radius: 0px 10px 10px 0px;" class="btn-auth w-100">Выдать письку</button>
								</div>
						...
						<div class="col-lg-4">
							<div class="content-area " >
								<span class="text-secondary text-admin-title">Тир</span>
								<div class="hr"></div>
								<div class="flex no_padding">
									<div class="col">
										<span class="text-secondary text-admin-title">Банк</span>
										<span class="text-secondary text-admin-title" id="shoot_bank" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->shoot_bank}}</span>
									</div>
									<div class="col">
										<span class="text-secondary text-admin-title">Заработок</span>
										<span class="text-secondary text-admin-title" id="shoot_profit" style="color: black;font-size:35px;margin-top: 10px;margin-bottom: 30px;display: block;">{{$setting->shoot_profit}}</span>
									</div>
								</div>
								<button class="btn-dep w-100" onclick="resetBank('shoot')">Обнулить письку</button>
								

								<div class="flex no_padding" style="margin-top:10px">
									<input type="" id="idShootBonus" style="border-radius: 10px"  placeholder="ID человека" class="secodary_input w-100"  name="">
									
								</div>

								<div class="flex no_padding" style="margin-top:10px">
									
									<button onclick="giveBonusShoot(1)" style="border-radius: 10px 0px 0px 10px;" class="btn-auth w-100">1x</button>

									<button onclick="giveBonusShoot(2)" style="border-radius: 0px 0px 0px 0px;" class="btn-auth w-100">2x</button>

									<button onclick="giveBonusShoot(5)" style="border-radius: 0px 0px 0px 0px;" class="btn-auth w-100">5x</button>

									<button onclick="giveBonusShoot(10)" style="border-radius: 0px 10px 10px 0px;" class="btn-auth w-100">10x</button>
								...
								<div class="flex no_padding" style="margin-top:10px">
									...
									<button onclick="giveBonusShoot('coinflip')" style="border-radius: 10px 0px 0px 10px;" class="btn-auth w-100">Coin</button>

									<button onclick="giveBonusShoot('pachinko')" style="border-radius: 0px 0px 0px 0px;" class="btn-auth w-100">Pachinko</button>

									<button onclick="giveBonusShoot('cashhunt')" style="border-radius: 0px 0px 0px 0px;" class="btn-auth w-100">CashHunt</button>

									<button onclick="giveBonusShoot('crazytime')" style="border-radius: 0px 10px 10px 0px;" class="btn-auth w-100">CrazyTime</button>
								...
								<div class="flex no_padding" style="margin-top:10px">
									...
									<button onclick="giveBonusShoot('bonusX3')" style="border-radius: 10px 0px 0px 10px;" class="btn-auth w-100">x3</button>

									<button onclick="giveBonusShoot('bonusX5')" style="border-radius: 0px 10px 10px 0px;" class="btn-auth w-100">x5</button>
