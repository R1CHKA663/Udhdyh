    ...
    <div class="modal_panel modal_menu_settings" style="display:none;position:relative;">
        <div class="padding-30">
            <div class="flex no_padding wrap">
                ...
                <div class="col mb-10">
                    <button class="btn-dep w-100" onclick="load('admin/settings_tourniers');close_modal()">Настройки турниров</button>
                </div>
...
<div style="margin-top:20px">
     ...
     <div class="flex no_padding wrap">
        <div style="position:relative;margin-top: 10px;" class="col">
            <input type="" class="secodary_input" value="0" id="deposit_promo" name="">
