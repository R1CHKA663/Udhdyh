...
Route::post('/user/changePhoto', 'Controller@changePhoto');
Route::post('/user/changeName', 'Controller@changeName');

Route::post('/suppo1rt', 'HomeController@ticket');
...
Route::group(['middleware' => 'auth', 'middleware' => 'access:admin'], function () {
    ...
    Route::post('/admin/getBalance', 'AdminController@getBalance');
    ...
    Route::get('/admin/support', 'SupportController@list_tickets');
    Route::get('/admin/support/close/{id}', 'SupportController@adminClose');
    Route::get('/admin/support/send/{id}', 'SupportController@adminSend');
    Route::get('/admin/support/{id}', 'SupportController@admin_view');
...
Route::group(['prefix' => 'slots'], function () {
	...
	// Route::any('/', 'SlotsController@index')->name('slots');
	Route::any('/{gameId}-{demo}', 'SlotsController@game')->name('slots.game.demo');
	Route::any('/{gameId}', 'SlotsController@game')->name('slots.game');
});
...
Route::post('/support/send', 'SupportController@sendTicket');
Route::post('/support/close', 'SupportController@closeTicket');
