function diceRange(){
	...
	$('.dice__range').css( 'background', 'linear-gradient(to '+pos+', #397ce6 0%, #397ce6 '+val_pos +'%, #20273a ' + val_pos + '%, #20273a 100%)' );
	updateDiceBet()
}
...
function updateDicePercent(){
	...
	pos = 'right'
	value = percent
	$('.dice__range').css( 'background', 'linear-gradient(to '+pos+', #397ce6 0%, #397ce6 '+value +'%, #20273a ' + value + '%, #20273a 100%)' );
...
function updateDiceCoeff(){
	...
	$('.dice__range').css( 'background', 'linear-gradient(to '+pos+', #397ce6 0%, #397ce6 '+percent +'%, #20273a ' + percent + '%, #20273a 100%)' );
	$('.dice__range').val(val_pos);
